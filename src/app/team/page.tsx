...
export default function TeamPage() {
  ...
  const filteredMembers = useMemo(() => {
    ...
    const members = allMembers[selectedTeam.title as keyof typeof allMembers] || [];
          ...
          >
            ...
            >
              ...
              <div className="p-6 border-b">
                ...
                {/* Search Bar - chỉ hiển thị cho các ban khác Ban Chủ nhiệm */}
