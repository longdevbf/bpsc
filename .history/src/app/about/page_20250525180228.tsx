        ...
        <div className="container px-4 md:px-6">
          <AnimatedSection className="max-w-3xl mx-auto text-center">
            ...
            <AnimatedSection delay={0.3}>
              <Link href="/join">
                <Button
                  className="h-11 px-8 bg-white text-[#004987] hover:bg-gray-100 transition-all duration-300 hover:scale-105"
                >
        ...
        <div className="container px-4 md:px-6">
          <AnimatedSection className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/contact">
                <Button
                  className="h-11 px-8 border border-white text-white hover:bg-white/10 transition-all duration-300 hover:scale-105"
                >
